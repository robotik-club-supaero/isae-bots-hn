...
- ### Installer Docker sur le Raspberry

Cette étape nécessite de connecter temporairement le Raspberry à internet.
Attention, la procédure n'est pas la même que pour Ubuntu. Voir https://docs.docker.com/engine/install/raspberry-pi-os/. Si vous êtes en 64 bits et que ça ne fonctionne pas, essayez simplement :
...
- Adresse IP du Raspberry : `robot.local`
