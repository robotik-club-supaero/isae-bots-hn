...
make main CMD="source /opt/ros/noetic/setup.bash; source dev/devel/setup.bash; roslaunch scripts/match.launch BR:="/dev/ttyBR" ACT:="/dev/ttyACT" LIDAR:="/dev/ttyLIDAR" NANONPX:="/dev/ttyNANO"; $SHELL"
